...
public class ShuffleMethod {
    public static void main(String[] args) throws IOException {
        File input = new File("C:\\Users\\User\\IdeaProjects\\cybersecurityHW\\src\\main\\resources\\input\\input_file.txt");
        File encDir = new File("C:\\Users\\User\\IdeaProjects\\cybersecurityHW\\src\\main\\resources\\output_en");
        File decrDir = new File("C:\\Users\\User\\IdeaProjects\\cybersecurityHW\\src\\main\\resources\\output_decr");
    ...
    public static File encrypt(File input, File outDir, int[] shuffle) throws IOException {
        ...
        BufferedOutputStream outputStream = new BufferedOutputStream(new FileOutputStream(outFile), shuffle.length);
